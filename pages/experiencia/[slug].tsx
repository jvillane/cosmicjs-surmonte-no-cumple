      ...
      <div className="pb-20">
        <div className="relative bg-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            <h2 className="text-base font-semibold tracking-wider text-primary uppercase">La real experiencia
              Surmonte</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
              &ldquo;{experience.title}&rdquo;
            </p>
            <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
              Si quieres que tu experiencia <b className="text-primary">tenga eco</b> toma contacto con nosotros...
            </p>
          </div>
        </div>
        <div className="pb-16 bg-gradient-to-r from-primary to-primary-600 lg:pb-0 lg:z-10 lg:relative">
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div className="mt-12 lg:m-0 lg:col-span-2 lg:pl-8">
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                ...
                <span className="text-xl font-medium text-white">{experience.metadata.project.title}</span>
                  </footer>
                </blockquote>
              </div>
            </div>
