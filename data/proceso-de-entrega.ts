...
const DATA: Item[] = [
  {
    ...
    items: [
      'Parece obvio, pero ni la puerta ni el marco deben presentar daños, rayones o manchones (en caso de que se encuentre pintada). El barniz o pintura deben estar aplicados en todas las caras de la puerta, incluyendo la cara superior, que en general se descuida',
  ...
  },
  {
    ...
    paragraphs: [
      'La mayor parte de las propiedades se entregan vacías, sin muebles, a excepción de closets y cocina.',
    ...
    items: [
      ...
      'Las cubiertas no deben presentar daños, rayas o manchas, a veces se generan fallas en el material durante el proceso de corte, sobre todo en cubiertas de piedra',
      'Pon atención al tipo de pegamento que se utilizó para adherir lavaplatos y lavamanos a la cubierta, pues hemos detectados muchos casos donde han usado silicona, y con el peso termina cediendo',
    ]
  },
  {
    title: 'Instalaciones Eléctricas/Gas',
    label: LABELS.ELECTRICIDAD_GAS,
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Los planos más importantes son los de especialidades Eléctrico, Calefacción y Sanitario, junto con el de Arquitectura.',
    ...
    items: [
      ...
      'Si te los entregan en formato CAD, lo cuál es muy factible, te recomendamos que consigas a alguien que lo pueda traspasar a formato PDF, o alternativamente puedes descargar una versión \'Reader\' que permita visualizarlo',
  ...
  },
  {
    ...
    items: [
      ...
      'Mira de cerca y en detalle cada uno de los ventanales buscando rayas, usa la cinta de enmascarar (conocida como \'masking tape\') y marca cada uno de los rayones',
