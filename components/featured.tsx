...
export default function Featured({ phrases }: Props) {
  ...
  return (
    <div className="bg-white pt-16 lg:py-16">
      <div className="featured-h bg-gradient-to-r from-orange-500 to-pink-500">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:p-8 text-right justify-items-end">
          {phrases.map((phrase, i) => (
            <Transition
              ...
              <blockquote className="max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                <svg className="h-12 w-12 text-white opacity-25" fill="gray-400" viewBox="0 0 32 32" aria-hidden="true">
